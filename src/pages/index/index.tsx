...
const BRACELETS = [
  ...
  { label: '招财', tag: '金色', items: [
    ...
    { name: '富贵天成', desc: '蜜蜡 金发晶 金运石', score: '8.5', idx: [183, 130, 91, 183, 130, 91, 183, 130, 91, 183, 130, 91, 183, 130, 91, 183], rope: 'rgba(180,150,80,0.5)' },
  ]},
  { label: '人缘', tag: '粉色', items: [
    { name: '粉黛佳人', desc: '星光粉 草莓晶 粉晶双尖', score: '9.0', idx: [35, 72, 187, 35, 72, 187, 35, 72, 187, 35, 72, 187, 35, 72, 187, 35], rope: 'rgba(200,130,150,0.4)' },
    { name: '红鸾心动', desc: '鸽血红 果冻粉 星光粉', score: '8.6', idx: [75, 39, 35, 75, 39, 35, 75, 39, 35, 75, 39, 35, 75, 39, 35, 75], rope: 'rgba(200,100,130,0.4)' },
  ]},
  { label: '平安', tag: '绿色', items: [
    ...
    { name: '玉石养人', desc: '和田玉 碧玉 绿松石', score: '8.5', idx: [153, 157, 177, 153, 157, 177, 153, 157, 177, 153, 157, 177, 153, 157, 177, 153], rope: 'rgba(130,150,100,0.4)' },
  ]},
  { label: '文昌', tag: '蓝色', items: [
    { name: '睿智明澈', desc: '海蓝宝 白水晶 蓝月光', score: '8.8', idx: [43, 0, 64, 43, 0, 64, 43, 0, 64, 43, 0, 64, 43, 0, 64, 43], rope: 'rgba(100,140,200,0.4)' },
    { name: '金榜题名', desc: '黄水晶 白水晶 蓝晶石', score: '8.4', idx: [24, 0, 51, 24, 0, 51, 24, 0, 51, 24, 0, 51, 24, 0, 51, 24], rope: 'rgba(150,140,100,0.4)' },
  ]},
  // ===== 按色系 =====
  { label: '白色', tag: '纯净', items: [
    ...
    { name: '月华如水', desc: '白水晶 白水晶弯管 白幽灵', score: '8.4', idx: [0, 190, 7, 0, 190, 7, 0, 190, 7, 0, 190, 7, 0, 190, 7, 0], rope: 'rgba(200,205,210,0.3)' },
  ...
  { label: '紫色', tag: '神秘', items: [
    ...
    { name: '薰衣草', desc: '薰衣草紫晶 巴西紫晶 紫锂辉', score: '8.5', idx: [16, 12, 9, 16, 12, 9, 16, 12, 9, 16, 12, 9, 16, 12, 9, 16], rope: 'rgba(150,110,180,0.4)' },
    { name: '紫夜', desc: '乌拉圭紫晶 巴西紫晶 紫锂辉', score: '8.1', idx: [22, 13, 10, 22, 13, 10, 22, 13, 10, 22, 13, 10, 22, 13, 10, 22], rope: 'rgba(80,60,140,0.5)' },
  ]},
  { label: '粉色', tag: '温柔', items: [
    { name: '粉黛', desc: '星光粉 草莓晶 粉晶双尖', score: '8.8', idx: [35, 72, 187, 35, 72, 187, 35, 72, 187, 35, 72, 187, 35, 72, 187, 35], rope: 'rgba(200,130,150,0.4)' },
    { name: '桃夭', desc: '果冻粉 星光粉 白水晶', score: '8.3', idx: [39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39], rope: 'rgba(200,140,150,0.4)' },
  ]},
  { label: '红色', tag: '热情', items: [
    { name: '鸿运当头', desc: '南红 帝王砂 鸽血红', score: '8.8', idx: [163, 166, 75, 163, 166, 75, 163, 166, 75, 163, 166, 75, 163, 166, 75, 163], rope: 'rgba(180,60,60,0.4)' },
    { name: '赤诚', desc: '石榴石 红玛瑙 南红', score: '8.3', idx: [191, 78, 163, 191, 78, 163, 191, 78, 163, 191, 78, 163, 191, 78, 163, 191], rope: 'rgba(160,50,50,0.4)' },
  ]},
  { label: '绿色', tag: '清新', items: [
    { name: '绿野', desc: '绿幽灵 碧玉 葡萄石', score: '9.0', idx: [60, 157, 54, 60, 157, 54, 60, 157, 54, 60, 157, 54, 60, 157, 54, 60], rope: 'rgba(80,160,100,0.4)' },
    { name: '森系', desc: '绿发晶 绿萤石 青提岫玉', score: '8.4', idx: [114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114], rope: 'rgba(120,150,80,0.4)' },
    { name: '翡翠', desc: '碧玉 绿松石 绿龙晶', score: '8.1', idx: [158, 177, 81, 158, 177, 81, 158, 177, 81, 158, 177, 81, 158, 177, 81, 158], rope: 'rgba(100,180,120,0.4)' },
  ]},
  { label: '蓝色', tag: '宁静', items: [
    { name: '碧海', desc: '海蓝宝 蓝晶石 蓝月光', score: '8.8', idx: [43, 51, 64, 43, 51, 64, 43, 51, 64, 43, 51, 64, 43, 51, 64, 43], rope: 'rgba(80,140,200,0.4)' },
    { name: '深海', desc: '海纹石 蓝晶石 海蓝宝', score: '8.3', idx: [180, 52, 45, 180, 52, 45, 180, 52, 45, 180, 52, 45, 180, 52, 45, 180], rope: 'rgba(60,120,180,0.4)' },
  ]},
  { label: '金色', tag: '阳光', items: [
    ...
    { name: '暖阳', desc: '黄水晶 黄塔晶 金曜石', score: '8.4', idx: [24, 31, 86, 24, 31, 86, 24, 31, 86, 24, 31, 86, 24, 31, 86, 24], rope: 'rgba(200,160,80,0.5)' },
    { name: '落日', desc: '金虎眼 黄虎眼 金发晶', score: '8.1', idx: [101, 107, 128, 101, 107, 128, 101, 107, 128, 101, 107, 128, 101, 107, 128, 101], rope: 'rgba(180,150,70,0.5)' },
  ]},
  { label: '木质', tag: '古朴', items: [
    ...
    { name: '山野', desc: '猴头 树王 百香籽', score: '8.1', idx: [140, 137, 139, 140, 137, 139, 140, 137, 139, 140, 137, 139, 140, 137, 139, 140], rope: 'rgba(100,70,40,0.6)' },
  ]},
]
