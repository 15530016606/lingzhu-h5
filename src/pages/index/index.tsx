...
const BRACELETS = [
  ...
  { label: '财运亨通', tag: '招财', items: [
    ...
    { name: '八方来财', desc: '黄水晶 金发晶 白水晶', score: '8.7', idx: [26, 130, 3, 26, 130, 3, 26, 130, 3, 26, 130, 3, 26, 130, 3, 26], rope: 'rgba(170,150,90,0.5)' },
    { name: '招财进宝', desc: '金曜石 黄塔晶 黄虎眼', score: '8.3', idx: [88, 31, 107, 88, 31, 107, 88, 31, 107, 88, 31, 107, 88, 31, 107, 88], rope: 'rgba(150,120,70,0.5)' },
  ]},
  { label: '桃花人缘', tag: '人缘', items: [
    ...
    { name: '红粉佳人', desc: '红胶花 粉水晶 白水晶', score: '8.5', idx: [123, 187, 4, 123, 187, 4, 123, 187, 4, 123, 187, 4, 123, 187, 4, 123], rope: 'rgba(200,100,120,0.4)' },
    { name: '良缘天定', desc: '草莓晶 鸽血红 红玛瑙', score: '8.1', idx: [74, 76, 79, 74, 76, 79, 74, 76, 79, 74, 76, 79, 74, 76, 79, 74], rope: 'rgba(200,80,100,0.4)' },
  ]},
  { label: '健康平安', tag: '平安', items: [
    ...
    { name: '长生久视', desc: '绿发晶 碧玉 白水晶', score: '8.2', idx: [114, 155, 2, 114, 155, 2, 114, 155, 2, 114, 155, 2, 114, 155, 2, 114], rope: 'rgba(120,150,100,0.4)' },
    { name: '紫气护体', desc: '紫金砂 帝王砂 南红', score: '8.0', idx: [167, 166, 164, 167, 166, 164, 167, 166, 164, 167, 166, 164, 167, 166, 164, 167], rope: 'rgba(120,60,80,0.5)' },
  ]},
  { label: '学业精进', tag: '文昌', items: [
    ...
    { name: '沉稳干练', desc: '蓝虎眼 黑曜石 茶水晶', score: '8.2', idx: [105, 96, 83, 105, 96, 83, 105, 96, 83, 105, 96, 83, 105, 96, 83, 105], rope: 'rgba(60,60,80,0.5)' },
    { name: '文思泉涌', desc: '海蓝宝 白水晶 蓝晶石', score: '8.5', idx: [47, 0, 52, 47, 0, 52, 47, 0, 52, 47, 0, 52, 47, 0, 52, 47], rope: 'rgba(100,140,200,0.4)' },
    { name: '金榜题名', desc: '黄水晶 金运石 白水晶', score: '8.3', idx: [24, 91, 3, 24, 91, 3, 24, 91, 3, 24, 91, 3, 24, 91, 3, 24], rope: 'rgba(160,140,80,0.5)' },
  ]},
  // --- 按色系 ---
  { label: '白色系', tag: '纯净', items: [
    { name: '冰清玉洁', desc: '白水晶 白幽灵 白水晶方糖', score: '8.8', idx: [0, 5, 189, 0, 5, 189, 0, 5, 189, 0, 5, 189, 0, 5, 189, 0], rope: 'rgba(200,210,220,0.4)' },
    { name: '月华如水', desc: '白水晶 灰月光 白水晶弯管', score: '8.5', idx: [2, 63, 190, 2, 63, 190, 2, 63, 190, 2, 63, 190, 2, 63, 190, 2], rope: 'rgba(180,190,200,0.4)' },
    { name: '雪落无声', desc: '白幽灵 白水晶 银曜石', score: '8.2', idx: [7, 0, 93, 7, 0, 93, 7, 0, 93, 7, 0, 93, 7, 0, 93, 7], rope: 'rgba(190,200,210,0.4)' },
    { name: '白玉无瑕', desc: '白水晶冰块 白水晶 白幽灵', score: '8.0', idx: [203, 3, 6, 203, 3, 6, 203, 3, 6, 203, 3, 6, 203, 3, 6, 203], rope: 'rgba(200,200,210,0.4)' },
  ]},
  { label: '紫色系', tag: '神秘', items: [
    ...
    { name: '薰衣草之梦', desc: '薰衣草紫晶 紫锂辉 白水晶', score: '8.6', idx: [16, 15, 1, 16, 15, 1, 16, 15, 1, 16, 15, 1, 16, 15, 1, 16], rope: 'rgba(150,100,180,0.4)' },
    { name: '紫醉金迷', desc: '紫锂辉 金发晶 白水晶', score: '8.4', idx: [10, 130, 4, 10, 130, 4, 10, 130, 4, 10, 130, 4, 10, 130, 4, 10], rope: 'rgba(130,80,150,0.4)' },
    { name: '夜幕紫晶', desc: '乌拉圭紫晶 黑曜石 紫锂辉', score: '8.1', idx: [22, 97, 9, 22, 97, 9, 22, 97, 9, 22, 97, 9, 22, 97, 9, 22], rope: 'rgba(80,60,120,0.5)' },
    { name: '紫霞漫天', desc: '巴西紫晶 薰衣草紫晶 白水晶', score: '8.3', idx: [13, 18, 2, 13, 18, 2, 13, 18, 2, 13, 18, 2, 13, 18, 2, 13], rope: 'rgba(140,90,170,0.4)' },
  ]},
  { label: '粉色系', tag: '温柔', items: [
    { name: '粉红泡泡', desc: '星光粉 果冻粉 鸽血红', score: '8.9', idx: [35, 39, 75, 35, 39, 75, 35, 39, 75, 35, 39, 75, 35, 39, 75, 35], rope: 'rgba(200,120,140,0.4)' },
    { name: '草莓甜心', desc: '草莓晶 红玛瑙 粉水晶', score: '8.4', idx: [72, 78, 37, 72, 78, 37, 72, 78, 37, 72, 78, 37, 72, 78, 37, 72], rope: 'rgba(200,80,100,0.4)' },
    { name: '胭脂扣', desc: '鸽血红 紫锂辉 粉晶', score: '8.6', idx: [77, 15, 38, 77, 15, 38, 77, 15, 38, 77, 15, 38, 77, 15, 38, 77], rope: 'rgba(200,90,120,0.4)' },
    { name: '桃色夭夭', desc: '果冻粉 大漆葫芦粉 白水晶', score: '8.2', idx: [41, 136, 3, 41, 136, 3, 41, 136, 3, 41, 136, 3, 41, 136, 3, 41], rope: 'rgba(210,110,130,0.4)' },
    { name: '初恋', desc: '星光粉 红胶花 白幽灵', score: '8.0', idx: [37, 124, 5, 37, 124, 5, 37, 124, 5, 37, 124, 5, 37, 124, 5, 37], rope: 'rgba(220,130,150,0.4)' },
  ]},
  { label: '绿色系', tag: '清新', items: [
    ...
    { name: '翡翠之恋', desc: '绿龙晶 绿幽灵 白水晶', score: '8.3', idx: [81, 61, 0, 81, 61, 0, 81, 61, 0, 81, 61, 0, 81, 61, 0, 81], rope: 'rgba(100,180,120,0.4)' },
    { name: '雨林', desc: '绿发晶 绿松石 绿檀', score: '8.1', idx: [115, 177, 147, 115, 177, 147, 115, 177, 147, 115, 177, 147, 115, 177, 147, 115], rope: 'rgba(80,140,80,0.4)' },
    { name: '青提', desc: '青提岫玉 碧玉 葡萄石', score: '8.4', idx: [161, 158, 55, 161, 158, 55, 161, 158, 55, 161, 158, 55, 161, 158, 55, 161], rope: 'rgba(140,180,100,0.4)' },
  ]},
  { label: '蓝色系', tag: '宁静', items: [
    ...
    { name: '深海之泪', desc: '海蓝宝 蓝水翡翠 海纹石', score: '8.3', idx: [47, 162, 180, 47, 162, 180, 47, 162, 180, 47, 162, 180, 47, 162, 180, 47], rope: 'rgba(60,120,180,0.4)' },
    { name: '星河', desc: '蓝月光 青金石 白水晶', score: '8.6', idx: [65, 199, 4, 65, 199, 4, 65, 199, 4, 65, 199, 4, 65, 199, 4, 65], rope: 'rgba(100,100,200,0.4)' },
    { name: '蔚蓝海岸', desc: '海蓝宝 蓝虎眼 银曜石', score: '8.1', idx: [45, 106, 94, 45, 106, 94, 45, 106, 94, 45, 106, 94, 45, 106, 94, 45], rope: 'rgba(80,120,180,0.4)' },
    { name: '蓝眼泪', desc: '蓝晶石 海纹石 海蓝宝', score: '8.4', idx: [52, 181, 44, 52, 181, 44, 52, 181, 44, 52, 181, 44, 52, 181, 44, 52], rope: 'rgba(80,160,200,0.4)' },
  ]},
  { label: '金色系', tag: '温暖', items: [
    ...
    { name: '落日余晖', desc: '金虎眼 黄虎眼 白水晶', score: '8.4', idx: [103, 107, 2, 103, 107, 2, 103, 107, 2, 103, 107, 2, 103, 107, 2, 103], rope: 'rgba(180,150,70,0.5)' },
    { name: '琥珀流光', desc: '蜜蜡 柠檬黄 冰糖黄', score: '8.2', idx: [183, 26, 29, 183, 26, 29, 183, 26, 29, 183, 26, 29, 183, 26, 29, 183], rope: 'rgba(200,170,90,0.5)' },
    { name: '金色麦浪', desc: '黄塔晶 金运石 白水晶', score: '8.0', idx: [33, 91, 0, 33, 91, 0, 33, 91, 0, 33, 91, 0, 33, 91, 0, 33], rope: 'rgba(160,140,80,0.5)' },
  ]},
]
