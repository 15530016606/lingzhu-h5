...
function calcBraceletPrice(idxs: number[]): string {
  let total = 0
  for (const i of idxs) {
    const p = BEAD_PRODUCTS[i]
    if (!p) continue
...
const BRACELETS = [
  ...
  { label: '招财', tag: '金色', items: [
    { name: '财源广进', desc: '金发晶 黄水晶', idx: [128, 24, 128, 24, 128, 24, 128, 24, 128, 24, 128, 24, 128, 24, 128, 24], rope: 'rgba(180,140,60,0.5)' },
    { name: '堆金积玉', desc: '金曜石 蜜蜡', idx: [86, 183, 86, 183, 86, 183, 86, 183, 86, 183, 86, 183, 86, 183, 86, 183], rope: 'rgba(170,130,50,0.5)' },
    { name: '日进斗金', desc: '金虎眼 金发晶 黄塔晶', idx: [101, 128, 31, 101, 128, 31, 101, 128, 31, 101, 128, 31, 101, 128, 31, 101], rope: 'rgba(180,150,70,0.5)' },
    { name: '富贵天成', desc: '蜜蜡 金运石 金发晶', idx: [183, 91, 130, 183, 91, 130, 183, 91, 130, 183, 91, 130, 183, 91, 130, 183], rope: 'rgba(190,160,80,0.5)' },
  ]},
  { label: '人缘', tag: '粉色', items: [
    { name: '粉黛佳人', desc: '星光粉 草莓晶', idx: [35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72], rope: 'rgba(200,130,150,0.4)' },
    { name: '红鸾心动', desc: '鸽血红 果冻粉', idx: [75, 39, 75, 39, 75, 39, 75, 39, 75, 39, 75, 39, 75, 39, 75, 39], rope: 'rgba(200,100,130,0.4)' },
    { name: '桃之夭夭', desc: '果冻粉 星光粉 白水晶', idx: [39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39], rope: 'rgba(210,140,150,0.4)' },
    { name: '甜蜜蜜', desc: '草莓晶 粉晶双尖 星光粉', idx: [72, 187, 35, 72, 187, 35, 72, 187, 35, 72, 187, 35, 72, 187, 35, 72], rope: 'rgba(200,120,140,0.4)' },
  ]},
  { label: '平安', tag: '绿色', items: [
    { name: '翠色清风', desc: '绿幽灵 碧玉 葡萄石', idx: [60, 157, 54, 60, 157, 54, 60, 157, 54, 60, 157, 54, 60, 157, 54, 60], rope: 'rgba(100,160,100,0.4)' },
    { name: '玉石养人', desc: '和田玉 碧玉 绿松石', idx: [153, 157, 177, 153, 157, 177, 153, 157, 177, 153, 157, 177, 153, 157, 177, 153], rope: 'rgba(130,150,100,0.4)' },
    { name: '清静自在', desc: '绿发晶 绿萤石 青提岫玉', idx: [114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114], rope: 'rgba(120,150,80,0.4)' },
    { name: '福寿安康', desc: '沉香 绿幽灵 葡萄石', idx: [142, 60, 54, 142, 60, 54, 142, 60, 54, 142, 60, 54, 142, 60, 54, 142], rope: 'rgba(100,120,80,0.5)' },
  ]},
  { label: '文昌', tag: '蓝色', items: [
    { name: '睿智明澈', desc: '海蓝宝 白水晶 蓝月光', idx: [43, 0, 64, 43, 0, 64, 43, 0, 64, 43, 0, 64, 43, 0, 64, 43], rope: 'rgba(100,140,200,0.4)' },
    { name: '金榜题名', desc: '黄水晶 白水晶 蓝晶石', idx: [24, 0, 51, 24, 0, 51, 24, 0, 51, 24, 0, 51, 24, 0, 51, 24], rope: 'rgba(150,140,100,0.4)' },
    { name: '宁静致远', desc: '蓝晶石 海蓝宝 白水晶', idx: [51, 45, 0, 51, 45, 0, 51, 45, 0, 51, 45, 0, 51, 45, 0, 51], rope: 'rgba(80,120,180,0.4)' },
  ]},
  // ===== 按色系 =====
  { label: '白色', tag: '纯净', items: [
    { name: '冰清玉洁', desc: '白水晶 白幽灵', idx: [0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7], rope: 'rgba(210,215,220,0.3)' },
    { name: '月华如水', desc: '白水晶 白水晶弯管', idx: [0, 190, 0, 190, 0, 190, 0, 190, 0, 190, 0, 190, 0, 190, 0, 190], rope: 'rgba(200,205,210,0.3)' },
    { name: '白玉', desc: '白水晶方糖 白水晶 白水晶双尖', idx: [189, 0, 185, 189, 0, 185, 189, 0, 185, 189, 0, 185, 189, 0, 185, 189], rope: 'rgba(205,210,215,0.3)' },
    { name: '雪落', desc: '白幽灵 白水晶 灰月光', idx: [8, 0, 63, 8, 0, 63, 8, 0, 63, 8, 0, 63, 8, 0, 63, 8], rope: 'rgba(190,195,200,0.3)' },
  ]},
  { label: '紫色', tag: '神秘', items: [
    { name: '紫气东来', desc: '巴西紫晶 乌拉圭紫晶 紫锂辉', idx: [11, 20, 9, 11, 20, 9, 11, 20, 9, 11, 20, 9, 11, 20, 9, 11], rope: 'rgba(120,80,160,0.4)' },
    { name: '薰衣草', desc: '薰衣草紫晶 巴西紫晶', idx: [16, 12, 16, 12, 16, 12, 16, 12, 16, 12, 16, 12, 16, 12, 16, 12], rope: 'rgba(150,110,180,0.4)' },
    { name: '紫夜', desc: '乌拉圭紫晶 巴西紫晶', idx: [22, 13, 22, 13, 22, 13, 22, 13, 22, 13, 22, 13, 22, 13, 22, 13], rope: 'rgba(80,60,140,0.5)' },
    { name: '紫霞', desc: '紫锂辉 薰衣草紫晶', idx: [9, 16, 9, 16, 9, 16, 9, 16, 9, 16, 9, 16, 9, 16, 9, 16], rope: 'rgba(140,90,170,0.4)' },
  ]},
  { label: '粉色', tag: '温柔', items: [
    { name: '粉黛', desc: '星光粉 草莓晶', idx: [35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72], rope: 'rgba(200,130,150,0.4)' },
    { name: '桃夭', desc: '果冻粉 星光粉 白水晶', idx: [39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39], rope: 'rgba(200,140,150,0.4)' },
    { name: '胭脂扣', desc: '果冻粉 粉晶双尖', idx: [41, 187, 41, 187, 41, 187, 41, 187, 41, 187, 41, 187, 41, 187, 41, 187], rope: 'rgba(210,120,140,0.4)' },
    { name: '草莓甜心', desc: '草莓晶 鸽血红 星光粉', idx: [72, 75, 35, 72, 75, 35, 72, 75, 35, 72, 75, 35, 72, 75, 35, 72], rope: 'rgba(200,100,120,0.4)' },
  ]},
  { label: '红色', tag: '热情', items: [
    { name: '鸿运当头', desc: '南红 鸽血红', idx: [163, 75, 163, 75, 163, 75, 163, 75, 163, 75, 163, 75, 163, 75, 163, 75], rope: 'rgba(180,60,60,0.4)' },
    { name: '朱砂', desc: '帝王砂 南红', idx: [166, 164, 166, 164, 166, 164, 166, 164, 166, 164, 166, 164, 166, 164, 166, 164], rope: 'rgba(160,40,40,0.5)' },
    { name: '赤诚', desc: '石榴石 红玛瑙', idx: [191, 78, 191, 78, 191, 78, 191, 78, 191, 78, 191, 78, 191, 78, 191, 78], rope: 'rgba(160,50,50,0.4)' },
    { name: '红豆', desc: '红胶花 鸽血红 红玛瑙', idx: [123, 76, 79, 123, 76, 79, 123, 76, 79, 123, 76, 79, 123, 76, 79, 123], rope: 'rgba(190,60,70,0.4)' },
  ]},
  { label: '绿色', tag: '清新', items: [
    { name: '绿野', desc: '绿幽灵 碧玉', idx: [60, 157, 60, 157, 60, 157, 60, 157, 60, 157, 60, 157, 60, 157, 60, 157], rope: 'rgba(80,160,100,0.4)' },
    { name: '森系', desc: '绿发晶 绿萤石 青提岫玉', idx: [114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114], rope: 'rgba(120,150,80,0.4)' },
    { name: '翡翠', desc: '碧玉 绿松石 绿龙晶', idx: [158, 177, 81, 158, 177, 81, 158, 177, 81, 158, 177, 81, 158, 177, 81, 158], rope: 'rgba(100,180,120,0.4)' },
    { name: '青提', desc: '青提岫玉 葡萄石 碧玉', idx: [160, 54, 157, 160, 54, 157, 160, 54, 157, 160, 54, 157, 160, 54, 157, 160], rope: 'rgba(140,180,100,0.4)' },
  ]},
  { label: '蓝色', tag: '宁静', items: [
    { name: '碧海', desc: '海蓝宝 蓝晶石', idx: [43, 51, 43, 51, 43, 51, 43, 51, 43, 51, 43, 51, 43, 51, 43, 51], rope: 'rgba(80,140,200,0.4)' },
    { name: '深海', desc: '海纹石 蓝晶石', idx: [180, 52, 180, 52, 180, 52, 180, 52, 180, 52, 180, 52, 180, 52, 180, 52], rope: 'rgba(60,120,180,0.4)' },
    { name: '星河', desc: '青金石 海蓝宝 蓝月光', idx: [199, 43, 64, 199, 43, 64, 199, 43, 64, 199, 43, 64, 199, 43, 64, 199], rope: 'rgba(100,100,200,0.4)' },
    { name: '夜海', desc: '青金石 蓝晶石', idx: [199, 51, 199, 51, 199, 51, 199, 51, 199, 51, 199, 51, 199, 51, 199, 51], rope: 'rgba(60,80,160,0.4)' },
  ]},
  { label: '金色', tag: '阳光', items: [
    { name: '鎏金', desc: '金发晶 金曜石', idx: [128, 86, 128, 86, 128, 86, 128, 86, 128, 86, 128, 86, 128, 86, 128, 86], rope: 'rgba(180,140,80,0.5)' },
    { name: '暖阳', desc: '黄水晶 黄塔晶', idx: [24, 31, 24, 31, 24, 31, 24, 31, 24, 31, 24, 31, 24, 31, 24, 31], rope: 'rgba(200,160,80,0.5)' },
    { name: '落日', desc: '金虎眼 黄虎眼', idx: [101, 107, 101, 107, 101, 107, 101, 107, 101, 107, 101, 107, 101, 107, 101, 107], rope: 'rgba(180,150,70,0.5)' },
    { name: '琥珀流光', desc: '蜜蜡 金发晶', idx: [183, 128, 183, 128, 183, 128, 183, 128, 183, 128, 183, 128, 183, 128, 183, 128], rope: 'rgba(190,160,90,0.5)' },
  ]},
  { label: '木质', tag: '古朴', items: [
    { name: '禅意', desc: '沉香 星月菩提', idx: [142, 141, 142, 141, 142, 141, 142, 141, 142, 141, 142, 141, 142, 141, 142, 141], rope: 'rgba(120,80,50,0.6)' },
    { name: '山野', desc: '猴头 树王', idx: [140, 137, 140, 137, 140, 137, 140, 137, 140, 137, 140, 137, 140, 137, 140, 137], rope: 'rgba(100,70,40,0.6)' },
    { name: '书香气', desc: '老山檀 黄杨木 沉香', idx: [149, 165, 144, 149, 165, 144, 149, 165, 144, 149, 165, 144, 149, 165, 144, 149], rope: 'rgba(130,90,60,0.6)' },
    { name: '福豆', desc: '树王 百香籽', idx: [137, 139, 137, 139, 137, 139, 137, 139, 137, 139, 137, 139, 137, 139, 137, 139], rope: 'rgba(110,80,50,0.6)' },
  ]},
]
