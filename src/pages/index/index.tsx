...
const BRACELETS = [
  // ===== 按寓意 =====
  { label: '招财', tag: '金色', items: [
    { name: '财源广进', desc: '金发晶 黄水晶', price: 128, idx: [128, 24, 128, 24, 128, 24, 128, 24, 128, 24, 128, 24, 128, 24, 128, 24], rope: 'rgba(180,140,60,0.5)' },
    { name: '堆金积玉', desc: '金曜石 蜜蜡', price: 86, idx: [86, 183, 86, 183, 86, 183, 86, 183, 86, 183, 86, 183, 86, 183, 86, 183], rope: 'rgba(170,130,50,0.5)' },
    { name: '日进斗金', desc: '金虎眼 金发晶 黄塔晶', price: 160, idx: [101, 128, 31, 101, 128, 31, 101, 128, 31, 101, 128, 31, 101, 128, 31, 101], rope: 'rgba(180,150,70,0.5)' },
    { name: '富贵天成', desc: '蜜蜡 金运石 金发晶', price: 148, idx: [183, 91, 130, 183, 91, 130, 183, 91, 130, 183, 91, 130, 183, 91, 130, 183], rope: 'rgba(190,160,80,0.5)' },
  ]},
  { label: '人缘', tag: '粉色', items: [
    { name: '粉黛佳人', desc: '星光粉 草莓晶', price: 36, idx: [35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72], rope: 'rgba(200,130,150,0.4)' },
    { name: '红鸾心动', desc: '鸽血红 果冻粉', price: 42, idx: [75, 39, 75, 39, 75, 39, 75, 39, 75, 39, 75, 39, 75, 39, 75, 39], rope: 'rgba(200,100,130,0.4)' },
    { name: '桃之夭夭', desc: '果冻粉 星光粉 白水晶', price: 30, idx: [39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39], rope: 'rgba(210,140,150,0.4)' },
    { name: '甜蜜蜜', desc: '草莓晶 粉晶双尖 星光粉', price: 40, idx: [72, 187, 35, 72, 187, 35, 72, 187, 35, 72, 187, 35, 72, 187, 35, 72], rope: 'rgba(200,120,140,0.4)' },
  ]},
  { label: '平安', tag: '绿色', items: [
    { name: '翠色清风', desc: '绿幽灵 碧玉 葡萄石', price: 68, idx: [60, 157, 54, 60, 157, 54, 60, 157, 54, 60, 157, 54, 60, 157, 54, 60], rope: 'rgba(100,160,100,0.4)' },
    { name: '玉石养人', desc: '和田玉 碧玉 绿松石', price: 56, idx: [153, 157, 177, 153, 157, 177, 153, 157, 177, 153, 157, 177, 153, 157, 177, 153], rope: 'rgba(130,150,100,0.4)' },
    { name: '清静自在', desc: '绿发晶 绿萤石 青提岫玉', price: 72, idx: [114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114], rope: 'rgba(120,150,80,0.4)' },
    { name: '福寿安康', desc: '沉香 绿幽灵 葡萄石', price: 88, idx: [142, 60, 54, 142, 60, 54, 142, 60, 54, 142, 60, 54, 142, 60, 54, 142], rope: 'rgba(100,120,80,0.5)' },
  ]},
  { label: '文昌', tag: '蓝色', items: [
    { name: '睿智明澈', desc: '海蓝宝 白水晶 蓝月光', price: 48, idx: [43, 0, 64, 43, 0, 64, 43, 0, 64, 43, 0, 64, 43, 0, 64, 43], rope: 'rgba(100,140,200,0.4)' },
    { name: '金榜题名', desc: '黄水晶 白水晶 蓝晶石', price: 36, idx: [24, 0, 51, 24, 0, 51, 24, 0, 51, 24, 0, 51, 24, 0, 51, 24], rope: 'rgba(150,140,100,0.4)' },
    { name: '宁静致远', desc: '蓝晶石 海蓝宝 白水晶', price: 30, idx: [51, 45, 0, 51, 45, 0, 51, 45, 0, 51, 45, 0, 51, 45, 0, 51], rope: 'rgba(80,120,180,0.4)' },
  ]},
  // ===== 按色系 =====
  { label: '白色', tag: '纯净', items: [
    { name: '冰清玉洁', desc: '白水晶 白幽灵', price: 8, idx: [0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7], rope: 'rgba(210,215,220,0.3)' },
    { name: '月华如水', desc: '白水晶 白水晶弯管', price: 10, idx: [0, 190, 0, 190, 0, 190, 0, 190, 0, 190, 0, 190, 0, 190, 0, 190], rope: 'rgba(200,205,210,0.3)' },
    { name: '白玉', desc: '白水晶方糖 白水晶 白水晶双尖', price: 12, idx: [189, 0, 185, 189, 0, 185, 189, 0, 185, 189, 0, 185, 189, 0, 185, 189], rope: 'rgba(205,210,215,0.3)' },
    { name: '雪落', desc: '白幽灵 白水晶 灰月光', price: 18, idx: [8, 0, 63, 8, 0, 63, 8, 0, 63, 8, 0, 63, 8, 0, 63, 8], rope: 'rgba(190,195,200,0.3)' },
  ]},
  { label: '紫色', tag: '神秘', items: [
    { name: '紫气东来', desc: '巴西紫晶 乌拉圭紫晶 紫锂辉', price: 54, idx: [11, 20, 9, 11, 20, 9, 11, 20, 9, 11, 20, 9, 11, 20, 9, 11], rope: 'rgba(120,80,160,0.4)' },
    { name: '薰衣草', desc: '薰衣草紫晶 巴西紫晶', price: 40, idx: [16, 12, 16, 12, 16, 12, 16, 12, 16, 12, 16, 12, 16, 12, 16, 12], rope: 'rgba(150,110,180,0.4)' },
    { name: '紫夜', desc: '乌拉圭紫晶 巴西紫晶', price: 46, idx: [22, 13, 22, 13, 22, 13, 22, 13, 22, 13, 22, 13, 22, 13, 22, 13], rope: 'rgba(80,60,140,0.5)' },
    { name: '紫霞', desc: '紫锂辉 薰衣草紫晶', price: 36, idx: [9, 16, 9, 16, 9, 16, 9, 16, 9, 16, 9, 16, 9, 16, 9, 16], rope: 'rgba(140,90,170,0.4)' },
  ]},
  { label: '粉色', tag: '温柔', items: [
    { name: '粉黛', desc: '星光粉 草莓晶', price: 36, idx: [35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72, 35, 72], rope: 'rgba(200,130,150,0.4)' },
    { name: '桃夭', desc: '果冻粉 星光粉 白水晶', price: 30, idx: [39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39], rope: 'rgba(200,140,150,0.4)' },
    { name: '胭脂扣', desc: '果冻粉 粉晶双尖', price: 28, idx: [41, 187, 41, 187, 41, 187, 41, 187, 41, 187, 41, 187, 41, 187, 41, 187], rope: 'rgba(210,120,140,0.4)' },
    { name: '草莓甜心', desc: '草莓晶 鸽血红 星光粉', price: 48, idx: [72, 75, 35, 72, 75, 35, 72, 75, 35, 72, 75, 35, 72, 75, 35, 72], rope: 'rgba(200,100,120,0.4)' },
  ]},
  { label: '红色', tag: '热情', items: [
    { name: '鸿运当头', desc: '南红 鸽血红', price: 56, idx: [163, 75, 163, 75, 163, 75, 163, 75, 163, 75, 163, 75, 163, 75, 163, 75], rope: 'rgba(180,60,60,0.4)' },
    { name: '朱砂', desc: '帝王砂 南红', price: 48, idx: [166, 164, 166, 164, 166, 164, 166, 164, 166, 164, 166, 164, 166, 164, 166, 164], rope: 'rgba(160,40,40,0.5)' },
    { name: '赤诚', desc: '石榴石 红玛瑙', price: 20, idx: [191, 78, 191, 78, 191, 78, 191, 78, 191, 78, 191, 78, 191, 78, 191, 78], rope: 'rgba(160,50,50,0.4)' },
    { name: '红豆', desc: '红胶花 鸽血红 红玛瑙', price: 52, idx: [123, 76, 79, 123, 76, 79, 123, 76, 79, 123, 76, 79, 123, 76, 79, 123], rope: 'rgba(190,60,70,0.4)' },
  ]},
  { label: '绿色', tag: '清新', items: [
    { name: '绿野', desc: '绿幽灵 碧玉', price: 48, idx: [60, 157, 60, 157, 60, 157, 60, 157, 60, 157, 60, 157, 60, 157, 60, 157], rope: 'rgba(80,160,100,0.4)' },
    { name: '森系', desc: '绿发晶 绿萤石 青提岫玉', price: 42, idx: [114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114, 58, 160, 114], rope: 'rgba(120,150,80,0.4)' },
    { name: '翡翠', desc: '碧玉 绿松石 绿龙晶', price: 36, idx: [158, 177, 81, 158, 177, 81, 158, 177, 81, 158, 177, 81, 158, 177, 81, 158], rope: 'rgba(100,180,120,0.4)' },
    { name: '青提', desc: '青提岫玉 葡萄石 碧玉', price: 30, idx: [160, 54, 157, 160, 54, 157, 160, 54, 157, 160, 54, 157, 160, 54, 157, 160], rope: 'rgba(140,180,100,0.4)' },
  ]},
  { label: '蓝色', tag: '宁静', items: [
    { name: '碧海', desc: '海蓝宝 蓝晶石', price: 36, idx: [43, 51, 43, 51, 43, 51, 43, 51, 43, 51, 43, 51, 43, 51, 43, 51], rope: 'rgba(80,140,200,0.4)' },
    { name: '深海', desc: '海纹石 蓝晶石', price: 28, idx: [180, 52, 180, 52, 180, 52, 180, 52, 180, 52, 180, 52, 180, 52, 180, 52], rope: 'rgba(60,120,180,0.4)' },
    { name: '星河', desc: '青金石 海蓝宝 蓝月光', price: 42, idx: [199, 43, 64, 199, 43, 64, 199, 43, 64, 199, 43, 64, 199, 43, 64, 199], rope: 'rgba(100,100,200,0.4)' },
    { name: '夜海', desc: '青金石 蓝晶石', price: 32, idx: [199, 51, 199, 51, 199, 51, 199, 51, 199, 51, 199, 51, 199, 51, 199, 51], rope: 'rgba(60,80,160,0.4)' },
  ]},
  { label: '金色', tag: '阳光', items: [
    { name: '鎏金', desc: '金发晶 金曜石', price: 88, idx: [128, 86, 128, 86, 128, 86, 128, 86, 128, 86, 128, 86, 128, 86, 128, 86], rope: 'rgba(180,140,80,0.5)' },
    { name: '暖阳', desc: '黄水晶 黄塔晶', price: 40, idx: [24, 31, 24, 31, 24, 31, 24, 31, 24, 31, 24, 31, 24, 31, 24, 31], rope: 'rgba(200,160,80,0.5)' },
    { name: '落日', desc: '金虎眼 黄虎眼', price: 52, idx: [101, 107, 101, 107, 101, 107, 101, 107, 101, 107, 101, 107, 101, 107, 101, 107], rope: 'rgba(180,150,70,0.5)' },
    { name: '琥珀流光', desc: '蜜蜡 金发晶', price: 98, idx: [183, 128, 183, 128, 183, 128, 183, 128, 183, 128, 183, 128, 183, 128, 183, 128], rope: 'rgba(190,160,90,0.5)' },
  ]},
  { label: '木质', tag: '古朴', items: [
    { name: '禅意', desc: '沉香 星月菩提', price: 56, idx: [142, 141, 142, 141, 142, 141, 142, 141, 142, 141, 142, 141, 142, 141, 142, 141], rope: 'rgba(120,80,50,0.6)' },
    { name: '山野', desc: '猴头 树王', price: 28, idx: [140, 137, 140, 137, 140, 137, 140, 137, 140, 137, 140, 137, 140, 137, 140, 137], rope: 'rgba(100,70,40,0.6)' },
    { name: '书香气', desc: '老山檀 黄杨木 沉香', price: 64, idx: [149, 165, 144, 149, 165, 144, 149, 165, 144, 149, 165, 144, 149, 165, 144, 149], rope: 'rgba(130,90,60,0.6)' },
    { name: '福豆', desc: '树王 百香籽', price: 22, idx: [137, 139, 137, 139, 137, 139, 137, 139, 137, 139, 137, 139, 137, 139, 137, 139], rope: 'rgba(110,80,50,0.6)' },
  ]},
]
    ...
    <div style={{ minHeight: '100vh', background: theme.bgPage }} onClick={resumeAudio}>
      <div style={{ overflowY: 'auto', flex: 1, padding: '16px 16px 0' }}>
                    ...
                    <div key={item.name}
                      ...
                      <div style={{ height: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4px 0' }}>
                        <div style={{ width: '100%', height: '100%', maxWidth: 100 }}>
                          <BeadPreviewRing beads={item.idx.map((i: number) => { const p = BEAD_PRODUCTS[i]; return p ? { ...p } : null }).filter(Boolean) as any[]} ropeColor={item.rope} onRemove={() => {}} compact static />
                        </div>
                      </div>
                      <div style={{ padding: '2px 10px 10px', textAlign: 'center' }}>
                        ...
                        <div style={{ fontSize: 9, color: theme.textSecondary, marginTop: 1 }}>{item.desc}</div>
                        <div style={{ fontSize: 10, fontWeight: 700, color: theme.accent, marginTop: 4 }}>
                          ¥{item.price}.00
                        </div>
                      </div>
                    </div>
        ...
        <div style={{
          ...
          background: 'linear-gradient(135deg, #f5efe4, #faf6ed)',
          border: `1px solid ${theme.borderLight}`,
        }}>
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 6 }}>
            <span style={{ fontSize: 18 }}>💪</span>
            <span style={{ fontSize: 13, fontWeight: 700, color: theme.textPrimary }}>自己动手 更省更酷</span>
          </div>
          <div style={{ fontSize: 11, color: theme.textSecondary, lineHeight: 1.8 }}>
            在采集源玩游戏获取原料 → 自己加工打磨成珠子
          </div>
          <div style={{
            marginTop: 6, padding: '6px 12px', borderRadius: 10, display: 'inline-block',
            background: `${theme.accent}22`,
          }}>
            <span style={{ fontSize: 12, fontWeight: 700, color: theme.accent }}>手工费仅需 ¥5.00</span>
          </div>
          <div style={{ fontSize: 10, color: theme.textSecondary, marginTop: 4 }}>
            自己采集的珠子免费串，只收一根绳子的手工钱
          </div>
        </div>
