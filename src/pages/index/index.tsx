...
const BRACELETS = [
  ...
  { label: '财运亨通', tag: '招财', items: [
    { name: '金玉满堂', desc: '金发晶 金曜石 黄水晶', score: '9.2', idx: [128, 86, 24, 128, 86, 24, 128, 86, 24, 128, 86, 24, 128, 86, 24, 128], rope: 'rgba(160,130,80,0.5)' },
    { name: '富贵连连', desc: '金虎眼 金运石 白水晶', score: '8.8', idx: [101, 91, 0, 101, 91, 0, 101, 91, 0, 101, 91, 0, 101, 91, 0, 101], rope: 'rgba(160,140,100,0.5)' },
    { name: '黄金万两', desc: '冰糖黄 柠檬黄 蜜蜡', score: '8.5', idx: [28, 24, 183, 28, 24, 0, 28, 24, 183, 28, 24, 0, 28, 24, 183, 28], rope: 'rgba(180,160,100,0.5)' },
    { name: '八方来财', desc: '黄水晶 金发晶 白水晶', score: '8.7', idx: [26, 130, 0, 26, 130, 0, 26, 130, 0, 26, 130, 0, 26, 130, 0, 26], rope: 'rgba(170,150,90,0.5)' },
    { name: '招财进宝', desc: '金曜石 黄塔晶 黄虎眼', score: '8.3', idx: [86, 31, 107, 86, 31, 107, 86, 31, 107, 86, 31, 107, 86, 31, 107, 86], rope: 'rgba(150,120,70,0.5)' },
  ]},
  { label: '桃花人缘', tag: '人缘', items: [
    { name: '粉黛佳人', desc: '星光粉 草莓晶 白水晶', score: '9.0', idx: [35, 72, 0, 35, 72, 0, 35, 72, 0, 35, 72, 0, 35, 72, 0, 35], rope: 'rgba(180,140,150,0.4)' },
    { name: '倾国倾城', desc: '鸽血红 果冻粉 粉晶', score: '8.7', idx: [75, 39, 37, 75, 39, 37, 75, 39, 37, 75, 39, 37, 75, 39, 37, 75], rope: 'rgba(180,100,120,0.4)' },
    { name: '桃之夭夭', desc: '紫锂辉 星光粉 白水晶', score: '8.3', idx: [9, 35, 0, 9, 35, 0, 9, 35, 0, 9, 35, 0, 9, 35, 0, 9], rope: 'rgba(160,120,140,0.4)' },
    { name: '红粉佳人', desc: '红胶花 粉水晶 白水晶', score: '8.5', idx: [123, 187, 0, 123, 187, 0, 123, 187, 0, 123, 187, 0, 123, 187, 0, 123], rope: 'rgba(200,100,120,0.4)' },
    { name: '良缘天定', desc: '草莓晶 鸽血红 红玛瑙', score: '8.1', idx: [72, 75, 78, 72, 75, 78, 72, 75, 78, 72, 75, 78, 72, 75, 78, 72], rope: 'rgba(200,80,100,0.4)' },
  ]},
  { label: '健康平安', tag: '平安', items: [
    { name: '翠色清风', desc: '绿幽灵 葡萄石 绿萤石', score: '9.1', idx: [60, 54, 58, 60, 54, 58, 60, 54, 58, 60, 54, 58, 60, 54, 58, 60], rope: 'rgba(100,160,100,0.4)' },
    { name: '玉石养人', desc: '碧玉 和田玉 南红', score: '8.6', idx: [157, 153, 163, 157, 153, 163, 157, 153, 163, 157, 153, 163, 157, 153, 163, 157], rope: 'rgba(140,120,80,0.4)' },
    { name: '清静自在', desc: '青提岫玉 绿松石 沉香', score: '8.4', idx: [160, 177, 142, 160, 177, 142, 160, 177, 142, 160, 177, 142, 160, 177, 142, 160], rope: 'rgba(80,120,100,0.5)' },
    { name: '长生久视', desc: '绿发晶 碧玉 白水晶', score: '8.2', idx: [114, 157, 0, 114, 157, 0, 114, 157, 0, 114, 157, 0, 114, 157, 0, 114], rope: 'rgba(120,150,100,0.4)' },
    { name: '紫气护体', desc: '紫金砂 帝王砂 南红', score: '8.0', idx: [167, 166, 163, 167, 166, 163, 167, 166, 163, 167, 166, 163, 167, 166, 163, 167], rope: 'rgba(120,60,80,0.5)' },
  ]},
  { label: '学业精进', tag: '文昌', items: [
    { name: '聪明睿智', desc: '蓝晶石 海蓝宝 紫锂辉', score: '9.0', idx: [51, 43, 9, 51, 43, 9, 51, 43, 9, 51, 43, 9, 51, 43, 9, 51], rope: 'rgba(80,120,180,0.4)' },
    { name: '步步高升', desc: '金发晶 金虎眼 银曜石', score: '8.7', idx: [128, 101, 92, 128, 101, 92, 128, 101, 92, 128, 101, 92, 128, 101, 92, 128], rope: 'rgba(140,120,100,0.5)' },
    { name: '沉稳干练', desc: '黑曜石 茶水晶 银曜石', score: '8.2', idx: [96, 83, 92, 96, 83, 92, 96, 83, 92, 96, 83, 92, 96, 83, 92, 96], rope: 'rgba(60,60,80,0.5)' },
    { name: '文思泉涌', desc: '海蓝宝 白水晶 蓝晶石', score: '8.5', idx: [43, 0, 51, 43, 0, 51, 43, 0, 51, 43, 0, 51, 43, 0, 51, 43], rope: 'rgba(100,140,200,0.4)' },
    { name: '金榜题名', desc: '黄水晶 金运石 白水晶', score: '8.3', idx: [24, 91, 0, 24, 91, 0, 24, 91, 0, 24, 91, 0, 24, 91, 0, 24], rope: 'rgba(160,140,80,0.5)' },
  ]},
  // --- 按色系（纯色组合）---
  { label: '白色系', tag: '纯净', items: [
    ...
    { name: '月华如水', desc: '白水晶 白水晶方糖 白水晶弯管', score: '8.5', idx: [0, 189, 190, 0, 189, 190, 0, 189, 190, 0, 189, 190, 0, 189, 190, 0], rope: 'rgba(200,205,210,0.3)' },
    { name: '雪落无声', desc: '白幽灵 白水晶 珍珠', score: '8.2', idx: [7, 0, 172, 7, 0, 172, 7, 0, 172, 7, 0, 172, 7, 0, 172, 7], rope: 'rgba(210,210,215,0.3)' },
    { name: '白玉无瑕', desc: '白水晶方糖 白水晶 白水晶弯管', score: '8.0', idx: [189, 0, 190, 189, 0, 190, 189, 0, 190, 189, 0, 190, 189, 0, 190, 189], rope: 'rgba(205,210,215,0.3)' },
  ]},
  { label: '紫色系', tag: '神秘', items: [
    { name: '紫气东来', desc: '巴西紫晶 紫锂辉 乌拉圭紫晶', score: '9.0', idx: [11, 9, 20, 11, 9, 20, 11, 9, 20, 11, 9, 20, 11, 9, 20, 11], rope: 'rgba(120,80,160,0.4)' },
    { name: '薰衣草之梦', desc: '薰衣草紫晶 紫锂辉 白水晶', score: '8.6', idx: [16, 9, 0, 16, 9, 0, 16, 9, 0, 16, 9, 0, 16, 9, 0, 16], rope: 'rgba(150,100,180,0.4)' },
    { name: '紫醉金迷', desc: '紫锂辉 巴西紫晶 白水晶', score: '8.4', idx: [9, 12, 0, 9, 12, 0, 9, 12, 0, 9, 12, 0, 9, 12, 0, 9], rope: 'rgba(130,80,150,0.4)' },
    { name: '夜幕紫晶', desc: '乌拉圭紫晶 紫锂辉 巴西紫晶', score: '8.1', idx: [20, 9, 13, 20, 9, 13, 20, 9, 13, 20, 9, 13, 20, 9, 13, 20], rope: 'rgba(80,60,120,0.5)' },
    { name: '紫霞漫天', desc: '巴西紫晶 薰衣草紫晶 紫锂辉', score: '8.3', idx: [11, 16, 9, 11, 16, 9, 11, 16, 9, 11, 16, 9, 11, 16, 9, 11], rope: 'rgba(140,90,170,0.4)' },
  ]},
  { label: '粉色系', tag: '温柔', items: [
    { name: '粉红泡泡', desc: '星光粉 果冻粉 粉晶', score: '8.9', idx: [35, 39, 187, 35, 39, 187, 35, 39, 187, 35, 39, 187, 35, 39, 187, 35], rope: 'rgba(200,120,140,0.4)' },
    { name: '草莓甜心', desc: '草莓晶 红玛瑙 粉晶', score: '8.4', idx: [72, 78, 37, 72, 78, 37, 72, 78, 37, 72, 78, 37, 72, 78, 37, 72], rope: 'rgba(200,80,100,0.4)' },
    { name: '胭脂扣', desc: '鸽血红 紫锂辉 粉晶', score: '8.6', idx: [75, 9, 38, 75, 9, 38, 75, 9, 38, 75, 9, 38, 75, 9, 38, 75], rope: 'rgba(200,90,120,0.4)' },
    { name: '桃色夭夭', desc: '果冻粉 星光粉 白水晶', score: '8.2', idx: [39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39, 35, 0, 39], rope: 'rgba(210,110,130,0.4)' },
    { name: '初恋', desc: '星光粉 红胶花 粉晶', score: '8.0', idx: [37, 123, 187, 37, 123, 187, 37, 123, 187, 37, 123, 187, 37, 123, 187, 37], rope: 'rgba(220,130,150,0.4)' },
  ]},
  { label: '红色系', tag: '热情', items: [
    { name: '红运当头', desc: '南红 红玛瑙 鸽血红', score: '8.8', idx: [163, 78, 75, 163, 78, 75, 163, 78, 75, 163, 78, 75, 163, 78, 75, 163], rope: 'rgba(180,60,60,0.4)' },
    { name: '朱砂痣', desc: '帝王砂 紫金砂 南红', score: '8.5', idx: [166, 167, 164, 166, 167, 164, 166, 167, 164, 166, 167, 164, 166, 167, 164, 166], rope: 'rgba(160,40,40,0.5)' },
    { name: '赤诚', desc: '石榴石 红玛瑙 南红', score: '8.2', idx: [191, 79, 163, 191, 79, 163, 191, 79, 163, 191, 79, 163, 191, 79, 163, 191], rope: 'rgba(160,50,50,0.4)' },
    { name: '红豆', desc: '红胶花 鸽血红 草莓晶', score: '8.0', idx: [123, 76, 73, 123, 76, 73, 123, 76, 73, 123, 76, 73, 123, 76, 73, 123], rope: 'rgba(190,60,70,0.4)' },
  ]},
  { label: '绿色系', tag: '清新', items: [
    { name: '绿野仙踪', desc: '绿幽灵 绿发晶 葡萄石', score: '9.1', idx: [60, 114, 54, 60, 114, 54, 60, 114, 54, 60, 114, 54, 60, 114, 54, 60], rope: 'rgba(80,160,100,0.4)' },
    { name: '森系物语', desc: '绿萤石 碧玉 青提岫玉', score: '8.5', idx: [58, 157, 160, 58, 157, 160, 58, 157, 160, 58, 157, 160, 58, 157, 160, 58], rope: 'rgba(120,140,80,0.4)' },
    { name: '翡翠之恋', desc: '绿龙晶 绿幽灵 碧玉', score: '8.3', idx: [81, 61, 155, 81, 61, 155, 81, 61, 155, 81, 61, 155, 81, 61, 155, 81], rope: 'rgba(100,180,120,0.4)' },
    { name: '雨林', desc: '绿发晶 绿松石 绿檀', score: '8.1', idx: [114, 177, 147, 114, 177, 147, 114, 177, 147, 114, 177, 147, 114, 177, 147, 114], rope: 'rgba(80,140,80,0.4)' },
    { name: '青提', desc: '青提岫玉 碧玉 葡萄石', score: '8.4', idx: [160, 157, 54, 160, 157, 54, 160, 157, 54, 160, 157, 54, 160, 157, 54, 160], rope: 'rgba(140,180,100,0.4)' },
  ]},
  { label: '蓝色系', tag: '宁静', items: [
    ...
    { name: '深海之泪', desc: '海蓝宝 蓝水翡翠 海纹石', score: '8.3', idx: [43, 162, 180, 43, 162, 180, 43, 162, 180, 43, 162, 180, 43, 162, 180, 43], rope: 'rgba(60,120,180,0.4)' },
    { name: '星河', desc: '蓝月光 青金石 海蓝宝', score: '8.6', idx: [64, 199, 44, 64, 199, 44, 64, 199, 44, 64, 199, 44, 64, 199, 44, 64], rope: 'rgba(100,100,200,0.4)' },
    { name: '蓝眼泪', desc: '蓝晶石 海纹石 海蓝宝', score: '8.4', idx: [51, 180, 43, 51, 180, 43, 51, 180, 43, 51, 180, 43, 51, 180, 43, 51], rope: 'rgba(80,160,200,0.4)' },
    { name: '夜海', desc: '青金石 海蓝宝 蓝晶石', score: '8.1', idx: [199, 45, 52, 199, 45, 52, 199, 45, 52, 199, 45, 52, 199, 45, 52, 199], rope: 'rgba(60,80,160,0.4)' },
  ]},
  { label: '金色系', tag: '温暖', items: [
    { name: '鎏金岁月', desc: '金发晶 金曜石 蜜蜡', score: '9.0', idx: [128, 86, 183, 128, 86, 183, 128, 86, 183, 128, 86, 183, 128, 86, 183, 128], rope: 'rgba(180,140,80,0.5)' },
    { name: '暖阳', desc: '柠檬黄 冰糖黄 黄塔晶', score: '8.6', idx: [24, 28, 31, 24, 28, 31, 24, 28, 31, 24, 28, 31, 24, 28, 31, 24], rope: 'rgba(200,160,80,0.5)' },
    { name: '落日余晖', desc: '金虎眼 黄虎眼 金曜石', score: '8.4', idx: [101, 107, 86, 101, 107, 86, 101, 107, 86, 101, 107, 86, 101, 107, 86, 101], rope: 'rgba(180,150,70,0.5)' },
    { name: '琥珀流光', desc: '蜜蜡 柠檬黄 冰糖黄', score: '8.2', idx: [183, 24, 28, 183, 24, 28, 183, 24, 28, 183, 24, 28, 183, 24, 28, 183], rope: 'rgba(200,170,90,0.5)' },
    { name: '麦浪', desc: '黄塔晶 金运石 金虎眼', score: '8.0', idx: [31, 91, 102, 31, 91, 102, 31, 91, 102, 31, 91, 102, 31, 91, 102, 31], rope: 'rgba(160,140,80,0.5)' },
  ]},
  { label: '木质系', tag: '古朴', items: [
    { name: '禅意', desc: '沉香 星月菩提 檀木', score: '8.6', idx: [142, 141, 146, 142, 141, 146, 142, 141, 146, 142, 141, 146, 142, 141, 146, 142], rope: 'rgba(120,80,50,0.6)' },
    { name: '山野', desc: '猴头屁桃 树王小金刚 百香籽', score: '8.3', idx: [140, 137, 139, 140, 137, 139, 140, 137, 139, 140, 137, 139, 140, 137, 139, 140], rope: 'rgba(100,70,40,0.6)' },
    { name: '书香', desc: '老山檀 黄杨木莲花 沉香', score: '8.0', idx: [149, 165, 143, 149, 165, 143, 149, 165, 143, 149, 165, 143, 149, 165, 143, 149], rope: 'rgba(120,90,60,0.6)' },
  ]},
]
